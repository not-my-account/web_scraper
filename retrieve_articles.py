...
# extract text and add to article database
...
hrd_nouns = ['reporter', 'journalist', 'commentator', 'cameraman']
hrd_verbs = ['hostage', 'kill', 'arrest', 'slaugther', 'detention', 'kidnap', 'torture', 'seize', 'assassination', 'execution', 'serious injury']
i = 1
for n in hrd_nouns:
    for v in hrd_verbs:
        ...
        gdelt_get_article_urls(dest='articles_database.csv',    # string: path to where to store the csv
                               ...
                               country='',                      # string: check https://gdelt.github.io/ html for codes
                               start='01-01-2022')              # string: start date not before 01.01.2017

get_article_text(path='articles_database.csv')
